...
def main():
    ...
    if infos_commune:
        nom_commune,lon_commune,lat_commune,date_debut,commune_composee = infos_commune[0]
    ...
    data = [nom_commune,lon_commune,lat_commune,a_voisins,insee_commune_parente, nom_commune_parente,date_debut,commune_composee]
